...
namespace Miningcore.Blockchain.Hodlcoin.Configuration;
...
public class HodlcoinPoolConfigExtra
{
    ...
    /// <summary>
    /// Set to true to limit RPC commands to old Hodlcoin command set
    /// </summary>
    ...
    /// Overrides property of same name from HodlcoinTemplate
    /// </summary>
